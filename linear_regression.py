...
# CrossValidation Score: 0.891939
# R2 Score(Train): 0.897734
# R2 Score(Test): 0.892187
# RMSE(Test): 14273.871119

os.makedirs("D:\\SalaryPredict", exist_ok=True)
save_path = os.path.join("D:\\SalaryPredict", 'linear_regression_model.pkl')
