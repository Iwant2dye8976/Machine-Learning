...
def Model_Train(model, X_train, X_test, y_train, y_test, kf, model_name):
    ...
    evaluation.loc[len(evaluation)] = [model_name, rmse, r2_train, r2_test, nse, cv]  # Lưu kết quả vào DataFrame
...
if __name__ == "__main__":
    ...
    for model_name, model in trains.items():
        Model_Train(model, X_train, X_test, y_train, y_test, kf, model_name)
