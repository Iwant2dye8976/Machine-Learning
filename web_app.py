...
years_of_experience = st.number_input('Số năm kinh nghiệm', min_value=0.0, max_value=50.0, value=0.0, step=1.0)  # Nhập số năm kinh nghiệm
...
# Hàm tải mô hình
def load_model(type):
    with open(f'.\\trained models\\{type}_model.pkl', 'rb') as file:
