...
# param_grid = {
#     'hidden_layer_sizes': [(50,), (100,), (50, 50)],  # Số neuron trong các lớp ẩn
#     'activation': ['relu', 'tanh'],  # Hàm kích hoạt
#     'solver': ['adam', 'lbfgs'],  # Thuật toán tối ưu
#     'alpha': [0.0001, 0.001, 0.01, 1, 10],  # Tham số điều chỉnh L2
#     'learning_rate': ['constant', 'adaptive'],  # Chiến lược tốc độ học
...
# Best parameters found: {'activation': 'relu', 'alpha': 0.001, 'hidden_layer_sizes': (100,), 'learning_rate': 'constant', 'max_iter': 1000, 'solver': 'lbfgs'}

# Đánh giá trên tập test
# print("Test set score:", param_search.score(X_test, y_test))
# Test set score: 0.8935065989125316
...
# CrossValidation Score: 0.890607
# R2 Score(Train): 0.902954
# R2 Score(Test): 0.893507
# RMSE(Test): 14186.255428

os.makedirs("D:\\SalaryPredict", exist_ok=True)
save_path = os.path.join("D:\\SalaryPredict", 'neural_network_model.pkl')
...
plt.title("Learning Curve with RMSE for Neural Network")
